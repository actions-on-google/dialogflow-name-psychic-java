# Actions on Google: Name Psychic Sample using Java
...
information on the Actions on Google platform using Java.
...
1. Reaplce `<YOUR_MAPS_KEY_HERE>` in `src/main/resources/config.properties` with your API Key for the Google Maps API.
